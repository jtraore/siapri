...
public class InsurerDetailCompositeProvider extends AbstractDetailCompositeProvider<Company> {
	...
	private Map<Company, InsurerDetail> insurerDetails;

	public InsurerDetailCompositeProvider(final String id) {
		super(id);
	}

	public void setInsurerDetails(final Map<Company, InsurerDetail> insurerDetails) {
