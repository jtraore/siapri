...
public class BrokerDataListModel extends DataListModel {
	...
	private void inititalize(final Composite parent) {
		...
		columnDescriptors[0] = new ColumnDescriptor("Login", 0.30, 125);
		columnDescriptors[1] = new ColumnDescriptor("Nom", 0.30, 125);
		columnDescriptors[2] = new ColumnDescriptor("Prénom", 0.30, 125);
